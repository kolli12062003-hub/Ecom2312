                ...
                <div className="popular-product-price-section">
                  {product.discountedPrice ? (
                    <>
                      ...
                      <div className="popular-product-original-price">₹{product.originalPrice.toLocaleString()}</div>

                      {/* Discounted Price - Prominent */}
                      <div className="popular-product-price discounted">₹{product.discountedPrice.toLocaleString()}</div>
                    ...
                    <div className="popular-product-price">₹{product.price.toLocaleString()}</div>
                  )}
                </div>
