...
const Organic = ({ wishlistItems, onAddToCart, onToggleWishlist, onViewProduct, cartItems, navigateTo, searchQuery, selectedVendor }) => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                console.log('Fetched Organic products:', data);
    ...
    // ✅ APPLY FILTERS
    useEffect(() => {
        console.log('Organic - Selected Vendor:', selectedVendor);
        console.log('Organic - Search Query:', searchQuery);
        console.log('Organic - Products Count:', products.length);
        ...
        console.log('Final Filtered Organic Products Count:', filtered.length);
                ...
                <div className="container">
                    <div className="vendor-header">
                        {selectedVendor ? (
                            <div style={{ marginBottom: '20px' }}>
                                <button className="back-button" onClick={() => navigateTo('organic')}>
                                    ← Back to Vendors
                                </button>
                                <h2 style={{ color: '#333', fontSize: '2rem', textAlign: 'center' }}>{selectedVendor} - Organic Veggies & Fruits</h2>
                            </div>
                        ) : (
                    ...
                    {!loading && !error && filteredProducts.length === 0 && (
                        <div className="no-results-message" style={{ textAlign: 'center', padding: '50px' }}>
                            <p>
                                No organic products found{selectedVendor ? ` in ${selectedVendor}` : ''}
